...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cechy = [
    { klasa: "cecha1", nazwa: "Ustrój polityczny", visible: true },
    { klasa: "cecha2", nazwa: "Konstytucja", visible: false },
    { klasa: "cecha3", nazwa: "Stolica", visible: true },
    { klasa: "cecha4", nazwa: "Data powstania", visible: true },
    { klasa: "cecha5", nazwa: "Data likwidacji", visible: true },
    { klasa: "cecha6", nazwa: "Władca", visible: false },
    { klasa: "cecha7", nazwa: "Prezydent", visible: false },
    { klasa: "cecha8", nazwa: "Premier", visible: false },
    { klasa: "cecha9", nazwa: "Powierzchnia", visible: false },
    { klasa: "cecha10", nazwa: "Populacja", visible: false },
    { klasa: "cecha11", nazwa: "Waluta", visible: false },
    { klasa: "cecha12", nazwa: "Telefoniczny nr kierunkowy", visible: false },
    { klasa: "cecha13", nazwa: "Domena internetowa", visible: false },
    { klasa: "cecha14", nazwa: "Kod samochodowy", visible: false },
    { klasa: "cecha15", nazwa: "Kod samolotowy", visible: false },
    { klasa: "cecha16", nazwa: "Strefa czasowa", visible: false },
    { klasa: "cecha17", nazwa: "Narody i grupy etniczne", visible: true },
    { klasa: "cecha18", nazwa: "Język urzędowy", visible: false },
    { klasa: "cecha19", nazwa: "Religia dominująca", visible: false },
    { klasa: "cecha20", nazwa: "Terytoria zależne", visible: false },
    { klasa: "cecha21", nazwa: "Terytoria autonomiczne", visible: false },
    { klasa: "cecha22", nazwa: "PKB", visible: false },
    { klasa: "cecha23", nazwa: "Lata istnienia", visible: true },
    { klasa: "cecha25", nazwa: "Hymn", visible: true },
    { klasa: "cecha24", nazwa: "Dewiza", visible: true },
  ];
