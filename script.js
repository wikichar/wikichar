...
function exportHTML() {
    ...
    clone.querySelectorAll(
        ".delete-btn, .add-img-btn, .remove-office, #toolbar, #addSectionBtn, #addOffice, #exportHTML, #exportPNG, .side-btn, .toggle-predecessor"
...
function exportPNG() {
    ...
    const ui = document.querySelectorAll(
        ".delete-btn, .add-img-btn, .remove-office, #toolbar, #addSectionBtn, .side-btn, .toggle-predecessor"
    );
...
function setPreview(mode) {
    ...
    document.querySelectorAll("[contenteditable]").forEach(el => {
        el.contentEditable = previewMode ? "false" : "true";
    });

    document.querySelectorAll(".side-btn, .add-img-btn, .delete-btn, .toggle-predecessor, .remove-office")
        .forEach(btn => {
